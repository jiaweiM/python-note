...
def test_create_str():
    movies = ['The Holy Grail',
              'The Life of Brian',
              'The meaning of Life']
    assert movies[1] == "The Life of Brian"
    ...
    print(cast)
    cast.remove("Chapman")
    assert cast == ['Cleese', 'Palin', 'Jone', 'Idle', 'Gilliam']
    cast.insert(0, "Chapman")
    assert cast == ["Chapman", 'Cleese', 'Palin', 'Jone', 'Idle', 'Gilliam']
...
def test_insert2():
    ...
    movies.insert(3, 1979)
    movies.insert(5, 1983)
    assert movies == ['The Holy Grail', 1975, 'The Life of Brian', 1979, 'The meaning of Life', 1983]
