...
- [教程](#%e6%95%99%e7%a8%8b)
  ...
  - [Python 模块](#python-%e6%a8%a1%e5%9d%97)
  - [集成模块](#%e9%9b%86%e6%88%90%e6%a8%a1%e5%9d%97)
  - [工具包](#%e5%b7%a5%e5%85%b7%e5%8c%85)
- [IDE](#ide)
- [工具包简介](#%e5%b7%a5%e5%85%b7%e5%8c%85%e7%ae%80%e4%bb%8b)
...
- [函数](basic/function.md)
- [集合](basic\collect_python.md)
- [IO](basic\python_io.md)
- [Python 异常处理](basic\python_exception.md)
- [property](basic\property.md)
- [Copy](basic/copy.md)
- [迭代器](basic/iterator.md)
- [生成器](basic/generator.md)
- [Closure](basic/closure.md)
- [Decorator](basic\decorator.md)
- [Commands](basic/commands.md)

## Python 模块
- [itertool](modules\itertool.md)
...
- [Unit Test - pytest](unittest/pytest.md)
...
## pandas
pandas 是一个 Python 包，提供快速、灵活和富有表现力的数据结构，旨在让“关系”或“标记”数据使用既简单又直观。它的目标是成为用 Python 进行实际，真实数据分析的基础高级构建块。
